...
Given all possible SQL commands order by order of query execution. (xSELECT,
DISTINCT, xFROM, xJOIN, xWHERE, xGROUP BY, xHAVING, xLIMIT/xOFFSET, ORDER).
