...
Function.prototype.myBind = function (context) {
    ...
    //ES 5 loses the content within the new function.
    //this becomes the window whenever define a new function.
    // we are setting a variable to equal this, and then calling apply on that variable
    // "that" is banana-able (we can say let banana = this; banana.apply(context))
